...
class AutoregressiveConditioner(Conditioner):
    ...
    """
    x: An input tensor_full with dim=[b_size, in_size]
    context: A context/conditionning tensor_full with dim=[b_size, cond_in]
    return: An autoregressive embedding tensor_full of x conditionned on context, its dim is=[b_size, in_size, out_size]
    """
